...
def getSeries(url):
		...
		for filme in filmes:
			titF = filme('div',{'class':'tt'})[0].text
			urlF = sbase + filme.a['href']
			imgF = filme.img['src']
            xbmc.log('[plugin.video.gofilmes] L107 - ' + str(urlF), xbmc.LOGNOTICE)
...
def getEpisodios(name, url):
        ...
        xbmc.log('[plugin.video.gofilmes] L181 - ' + str(url), xbmc.LOGNOTICE)
...
def player(name,url,iconimage):
        ...
        xbmc.log('[plugin.video.gofilmes] L332 - ' + str(urlVideo), xbmc.LOGNOTICE)
        ...
        xbmc.log('[plugin.video.gofilmes] L393 - ' + str(urlVideo), xbmc.LOGNOTICE)
...
def player_series(name,url,iconimage):
        ...
        xbmc.log('[plugin.video.gofilmes] L492 - ' + str(urlVideo), xbmc.LOGNOTICE)
        ...
        xbmc.log('[plugin.video.gofilmes] L558 - ' + str(urlVideo), xbmc.LOGNOTICE)
